 ...
 * 
 */
@Repository("areaPromotorDao")
@Transactional
public class AreaPromotorDaoImpl extends Dao<AreaPromotor> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AreaPromotor.class);

		criteria.createAlias("areaPromotorKey.institucion", "institucion");
