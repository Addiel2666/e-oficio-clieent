 ...
 * 
 */
@Repository("areaRevisorDao")
@Transactional
public class AreaRevisorDaoImpl extends Dao<AreaRevisor> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions,
		...
		Criteria criteria = getSession().createCriteria(AreaRevisor.class,"areaRevisor")
				.createAlias("areaRevisorKey.revisor", "revisor");
