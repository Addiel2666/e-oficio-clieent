 ...
 * 
 */
@Repository("asuntoConsultaDao")
@Transactional
public class AsuntoConsultaDaoImpl extends Dao<AsuntoConsulta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AsuntoConsulta.class, "asuntoConsulta");
