 ...
 * 
 */
@Repository("asuntoConsultaEspecialDao")
@Transactional
public class AsuntoConsultaEspecialDaoImpl extends Dao<AsuntoConsultaEspecial> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AsuntoConsultaEspecial.class, "AsuntoConsultaEspecial");
