 ...
 * 
 */
@Repository("asuntoRechazadoConsultaDao")
@Transactional
public class AsuntoRechazadoConsultaDaoImpl extends Dao<AsuntoRechazadoConsulta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AsuntoRechazadoConsulta.class, "asuntoRechazadoConsulta");
