 ...
 * 
 */
@Repository("asuntoRecibidoConsultaDao")
@Transactional
public class AsuntoRecibidoConsultaDaoImpl extends Dao<AsuntoRecibidoConsulta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AsuntoRecibidoConsulta.class, "asuntoRecibidoConsulta");
