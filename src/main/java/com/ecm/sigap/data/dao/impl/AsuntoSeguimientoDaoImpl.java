 ...
 * 
 */
@Repository("asuntoSeguimientoDao")
@Transactional
public class AsuntoSeguimientoDaoImpl extends Dao<AsuntoSeguimiento> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(AsuntoSeguimiento.class);
