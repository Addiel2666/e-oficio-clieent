 ...
 * 
 */
@Repository("contadoresViewDao")
@Transactional
public class ContadoresViewDaoImpl extends Dao<ContadoresView> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(ContadoresView.class);
