 ...
 * 
 */
@Repository("customAsuntoDao")
@Transactional
public class CustomAsuntoDaoImpl extends Dao<CustomAsunto> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(CustomAsunto.class, "customAsunto");
