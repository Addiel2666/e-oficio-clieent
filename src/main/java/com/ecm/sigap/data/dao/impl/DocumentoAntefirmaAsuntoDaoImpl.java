 ...
 * 
 */
@Repository("documentoAntefirmaAsuntoDao")
@Transactional
public class DocumentoAntefirmaAsuntoDaoImpl extends Dao<DocumentoAntefirmaAsunto> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoAntefirmaAsunto.class, "DocumentoAntefirmaAsunto");
