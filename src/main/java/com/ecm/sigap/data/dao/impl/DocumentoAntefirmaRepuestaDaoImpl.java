 ...
 * 
 */
@Repository("documentoAntefirmaRespuestaDao")
@Transactional
public class DocumentoAntefirmaRepuestaDaoImpl extends Dao<DocumentoAntefirmaRespuesta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoAntefirmaRespuesta.class,
				"DocumentoAntefirmaRespuesta");
