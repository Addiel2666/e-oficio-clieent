 ...
 * 
 */
@Repository("documentoAsuntoDao")
@Transactional
public class DocumentoAsuntoDaoImpl extends Dao<DocumentoAsunto> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoAsunto.class);
