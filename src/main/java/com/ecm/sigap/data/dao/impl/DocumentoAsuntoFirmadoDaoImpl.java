 ...
 * 
 */
@Repository("documentoAsuntoFirmadoDao")
@Transactional
public class DocumentoAsuntoFirmadoDaoImpl extends Dao<DocumentoAsuntoFirmado> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoAsuntoFirmado.class);
