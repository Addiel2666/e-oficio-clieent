 ...
 * 
 */
@Repository("documentoMinutarioDao")
@Transactional
public class DocumentoMinutarioDaoImpl extends Dao<DocumentoMinutario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoMinutario.class);
