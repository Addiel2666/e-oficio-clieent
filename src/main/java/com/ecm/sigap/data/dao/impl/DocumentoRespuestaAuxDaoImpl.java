 ...
 * 
 */
@Repository("documentoRespuestaAuxDao")
@Transactional
public class DocumentoRespuestaAuxDaoImpl extends Dao<DocumentoRespuestaAux> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoRespuestaAux.class);
