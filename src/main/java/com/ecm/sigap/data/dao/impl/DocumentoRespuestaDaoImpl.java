 ...
 * 
 */
@Repository("documentoRespuestaDao")
@Transactional
public class DocumentoRespuestaDaoImpl extends Dao<DocumentoRespuesta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoRespuesta.class);

		// criteria.createAlias("asuntoConsulta", "asuntoConsulta");
		// criteria.createAlias("respuestaConsulta.asuntoConsulta", "asuntoConsultaX");
