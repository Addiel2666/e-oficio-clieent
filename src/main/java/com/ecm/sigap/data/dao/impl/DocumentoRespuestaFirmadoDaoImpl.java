 ...
 * 
 */
@Repository("documentoRespuestaFirmadoDao")
@Transactional
public class DocumentoRespuestaFirmadoDaoImpl extends Dao<DocumentoRespuestaFirmado> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(DocumentoRespuestaFirmado.class);
