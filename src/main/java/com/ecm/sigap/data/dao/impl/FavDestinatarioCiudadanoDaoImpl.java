 ...
 * 
 */
@Repository("favDestinatarioCiudadanoDao")
@Transactional
public class FavDestinatarioCiudadanoDaoImpl extends Dao<FavDestinatarioCiudadano> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FavDestinatarioCiudadano.class, "favDestinatarioCiudadano");
