 ...
 * 
 */
@Repository("favDestinatarioFuncionarioDao")
@Transactional
public class FavDestinatarioFuncionarioDaoImpl extends Dao<FavDestinatarioFuncionario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FavDestinatarioFuncionario.class, "favDestinatarioFuncionario");
