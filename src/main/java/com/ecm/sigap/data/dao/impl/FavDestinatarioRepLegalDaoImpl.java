 ...
 * 
 */
@Repository("favDestinatarioRepLegalDao")
@Transactional
public class FavDestinatarioRepLegalDaoImpl extends Dao<FavDestinatarioRepLegal> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FavDestinatarioRepLegal.class, "favDestinatarioRepLegal");
