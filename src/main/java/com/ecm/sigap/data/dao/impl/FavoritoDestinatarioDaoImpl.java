 ...
 * 
 */
@Repository("favoritoDestinatarioDao")
@Transactional
public class FavoritoDestinatarioDaoImpl extends Dao<FavDestinatario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions,
		...
		Criteria criteria = getSession().createCriteria(FavDestinatario.class,
				"favoritoDestinatario");
