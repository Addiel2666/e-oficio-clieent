 ...
 * 
 */
@Repository("favoritoFirmanteDao")
@Transactional
public class FavoritoFirmanteDaoImpl extends Dao<FavoritoFirmante> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FavoritoFirmante.class, "favoritoFirmante");
