 ...
 * 
 */
@Repository("folioArchivisticaDao")
@Transactional
public class FolioArchivisticaDaoImpl extends Dao<FolioArchivistica> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FolioArchivistica.class);
