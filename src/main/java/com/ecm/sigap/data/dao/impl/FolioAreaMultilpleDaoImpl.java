 ...
 * 
 */
@Repository("folioAreaMultilpleDao")
@Transactional
public class FolioAreaMultilpleDaoImpl extends Dao<FolioAreaMultilple> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(FolioAreaMultilple.class);
