 ...
 * 
 */
@Repository("infomexModalidadEntregaDao")
@Transactional
public class InfomexModalidadEntregaDaoImpl extends Dao<InfomexModalidadEntrega> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexModalidadEntrega.class, "infomexModalidadEntrega");
