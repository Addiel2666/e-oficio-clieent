 ...
 * 
 */
@Repository("infomexMunicipioDao")
@Transactional
public class InfomexMunicipioDaoImpl extends Dao<InfomexMunicipio> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexMunicipio.class, "infomexMunicipio");
