 ...
 * 
 */
@Repository("infomexOcupacionDao")
@Transactional
public class InfomexOcupacionDaoImpl extends Dao<InfomexOcupacion> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexOcupacion.class, "infomexOcupacion");
