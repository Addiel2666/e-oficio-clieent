 ...
 * 
 */
@Repository("infomexPaisDao")
@Transactional
public class InfomexPaisDaoImpl extends Dao<InfomexPais> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexPais.class, "infomexPais");
