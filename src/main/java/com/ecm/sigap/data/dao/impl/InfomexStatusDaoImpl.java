 ...
 * 
 */
@Repository("infomexStatusDao")
@Transactional
public class InfomexStatusDaoImpl extends Dao<InfomexStatus> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexStatus.class, "infomexPais");
