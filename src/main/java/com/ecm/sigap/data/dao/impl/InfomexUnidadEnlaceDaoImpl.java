 ...
 * 
 */
@Repository("infomexUnidadEnlaceDao")
@Transactional
public class InfomexUnidadEnlaceDaoImpl extends Dao<InfomexUnidadEnlace> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(InfomexUnidadEnlace.class, "infomexUnidadEnlace");
