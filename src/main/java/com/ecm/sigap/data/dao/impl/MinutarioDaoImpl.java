 ...
 * 
 */
@Repository("minutarioDao")
@Transactional
public class MinutarioDaoImpl extends Dao<Minutario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(Minutario.class);

		criteria.createAlias("revisores", "revisor", JoinType.LEFT_OUTER_JOIN);
