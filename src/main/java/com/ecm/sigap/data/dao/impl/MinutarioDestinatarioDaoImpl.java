 ...
 * 
 */
@Repository("minutarioDestinatarioDao")
@Transactional
public class MinutarioDestinatarioDaoImpl extends Dao<MinutarioDestinatario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(MinutarioDestinatario.class, "minutarioDestinatario");
		
		criteria.createAlias("minutarioDestinatarioKey.areaDestinatario.titular", "titular");
