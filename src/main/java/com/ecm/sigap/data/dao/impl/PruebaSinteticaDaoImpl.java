 ...
 * 
 */
@Repository("pruebaSinteticaDao")
@Transactional
public class PruebaSinteticaDaoImpl extends Dao<PruebaSintetica> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(PruebaSintetica.class, "psint");
