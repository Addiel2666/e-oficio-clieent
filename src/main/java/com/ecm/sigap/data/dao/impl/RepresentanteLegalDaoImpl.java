 ...
 * 
 */
@Repository("representanteLegalDao")
@Transactional
public class RepresentanteLegalDaoImpl extends Dao<RepresentanteLegal> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(RepresentanteLegal.class);
