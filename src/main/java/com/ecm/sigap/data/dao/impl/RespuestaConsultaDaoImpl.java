 ...
 * 
 */
@Repository("respuestaConsultaDao")
@Transactional
public class RespuestaConsultaDaoImpl extends Dao<RespuestaConsulta> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(RespuestaConsulta.class, "respuestaConsulta");
