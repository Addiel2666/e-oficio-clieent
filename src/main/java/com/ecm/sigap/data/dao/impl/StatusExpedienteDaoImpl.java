 ...
 * 
 */
@Repository("statusExpedienteDao")
@Transactional
public class StatusExpedienteDaoImpl extends Dao<StatusExpediente> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(StatusExpediente.class);
