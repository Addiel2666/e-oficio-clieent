 ...
 * 
 */
@Repository("tipoExpedienteDao")
@Transactional
public class TipoExpedienteDaoImpl extends Dao<TipoExpediente> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(TipoExpediente.class);
