 ...
 * 
 */
@Repository("tipoInstruccionDao")
@Transactional
public class TipoInstruccionDaoImpl extends Dao<TipoInstruccion> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions,
		...
		Criteria criteria = getSession().createCriteria(TipoInstruccion.class);
