 ...
 * 
 */
@Repository("titularNoFavoritoDao")
@Transactional
public class TitularNoFavoritoDaoImpl extends Dao<TitularNoFavorito> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(TitularNoFavorito.class, "titularNoFavorito");
