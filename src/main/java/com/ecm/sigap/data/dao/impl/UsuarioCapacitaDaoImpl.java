 ...
 * 
 */
@Repository("usuarioCapacitaDao")
@Transactional
public class UsuarioCapacitaDaoImpl extends Dao<UsuarioCapacita> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(UsuarioCapacita.class);
