 ...
 * 
 */
@Repository("usuarioConectadoDao")
@Transactional
public class UsuarioConectadoDaoImpl extends Dao<UsuarioConectado> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(UsuarioConectado.class);
