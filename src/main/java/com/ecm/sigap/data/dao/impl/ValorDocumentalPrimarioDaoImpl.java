 ...
 * 
 */
@Repository("valorDocumentalPrimarioDao")
@Transactional
public class ValorDocumentalPrimarioDaoImpl extends Dao<ValorDocumentalPrimario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(ValorDocumentalPrimario.class);
