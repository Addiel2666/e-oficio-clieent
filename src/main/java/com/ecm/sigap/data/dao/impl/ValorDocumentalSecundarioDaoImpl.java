 ...
 * 
 */
@Repository("valorDocumentalSecundarioDao")
@Transactional
public class ValorDocumentalSecundarioDaoImpl extends Dao<ValorDocumentalSecundario> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(ValorDocumentalSecundario.class);
