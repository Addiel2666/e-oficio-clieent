 ...
 * 
 */
@Repository("wsSincronizaCompletaDetalleDao")
@Transactional
public class WsSincronizaCompletaDetalleDaoImpl extends Dao<WsSincronizaCompletaDetalle> {
	...
	protected Criteria createCriteria(List<Criterion> restrictions, List<Order> orders, ProjectionList projections,
		...
		Criteria criteria = getSession().createCriteria(WsSincronizaCompletaDetalle.class, "WsSincronizaCompletaDetalle");
