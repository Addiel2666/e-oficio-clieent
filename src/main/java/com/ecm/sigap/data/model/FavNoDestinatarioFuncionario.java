...
public class FavNoDestinatarioFuncionario implements Serializable {
	...
	/** The funcionario key. */
	@EmbeddedId
	private FavNoDestinatarioFuncionarioKey noFavfuncionarioKey;
	...
	/**
	 * Gets the no favfuncionario key.
	 *
	 * @return the no favfuncionario key
	 */
	public FavNoDestinatarioFuncionarioKey getNoFavfuncionarioKey() {
		return noFavfuncionarioKey;
	}

	/**
	 * Sets the no favfuncionario key.
	 *
	 * @param noFavfuncionarioKey
	 *            the new no favfuncionario key
	 */
	public void setNoFavfuncionarioKey(FavNoDestinatarioFuncionarioKey noFavfuncionarioKey) {
		this.noFavfuncionarioKey = noFavfuncionarioKey;
	}
	...
	public String toString() {
		return "FavNoDestinatarioFuncionario [noFavfuncionarioKey=" + noFavfuncionarioKey + ", idArea=" + idArea
				...
				+ ", idTipoRepresentante=" + idTipoRepresentante + ", paterno=" + paterno + ", materno=" + materno
				+ ", nombre=" + nombre + ", cargo=" + cargo + ", idAreaRepresentante=" + idAreaRepresentante
				+ ", areaRepresentate=" + areaRepresentate + ", cveareaRepresentante=" + cveareaRepresentante
