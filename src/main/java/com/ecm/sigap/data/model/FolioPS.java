...
/**
 * Clase de entidad que representa la tabla FOLIOPS
 *
...
@Entity
@Table(name = "FOLIOPS")
public class FolioPS implements java.io.Serializable {
	...
	@Column(name = "PREFIJOFOLIO", length = 40)
	 ...
	 */
	public FolioPS(Integer idArea, String prefijoFolio, String sufijoFolio) {
		this.idArea = idArea;
