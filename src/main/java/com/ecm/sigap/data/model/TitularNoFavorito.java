 ...
 */
@Entity
@Table(name = "TitularNoFavorito")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "ECM_SIGAP_V_CACHE_REGION")
public class TitularNoFavorito implements Serializable {
	...
	/** The favorito. */
	@EmbeddedId
	private FavoritoKey titularNoFavoritoKey;
	...
	/**
	 * Gets the titular no favorito key.
	 *
	 * @return the titular no favorito key
	 */
	public FavoritoKey getTitularNoFavoritoKey() {
		return titularNoFavoritoKey;
	}

	/**
	 * Sets the titular no favorito key.
	 *
	 * @param titularNoFavoritoKey
	 *            the new titular no favorito key
	 */
	public void setTitularNoFavoritoKey(FavoritoKey titularNoFavoritoKey) {
		this.titularNoFavoritoKey = titularNoFavoritoKey;
	}
	...
	public String toString() {
		return "TitularNoFavorito [titularNoFavoritoKey=" + titularNoFavoritoKey + ", firmArea=" + firmArea
				+ ", siglasArea=" + siglasArea + ", areactivosn=" + areactivosn + ", institucion=" + institucion
				+ ", idTipoInstitucion=" + idTipoInstitucion + ", institucionActivosn=" + institucionActivosn
				+ ", abrevInstitucion=" + abrevInstitucion + ", idTipoFirmante=" + idTipoFirmante + ", paterno="
				+ paterno + ", materno=" + materno + ", nombre=" + nombre + ", cargo=" + cargo + ", areaRepresentate="
				+ areaRepresentate + ", cveareaRepresentante=" + cveareaRepresentante + ", usuarioActivosn="
				+ usuarioActivosn + ", idTipoUsuario=" + idTipoUsuario + "]";
	}
