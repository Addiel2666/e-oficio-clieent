 ...
 *
 */
@Service("respuestaConsultaService")
public class RespuestaConsultaManagerImpl extends ManagerImpl<RespuestaConsulta> {

	/** Interfaz a base de datos. */
	@Autowired
	@Qualifier("respuestaConsultaDao")
	protected void setDao(EntityDAO<RespuestaConsulta> dao) {
		super.setDao(dao);
	}
