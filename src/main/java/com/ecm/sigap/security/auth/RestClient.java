...
import com.ecm.sigap.data.controller.impl.LoginController;
...
public class RestClient {
	 ...
	 * @throws IOException
	 */
	public HttpURLConnection post(String url, Map<String, Object> params)
			throws IOException {
		LOGGER.debug("::: Haciendo la peticion POST a la url '" + url + "' con los parametros '"
				+ params.toString() + "'");
	 ...
	 */
	private byte[] convertParamMapToBytes(Map<String, Object> params)
			throws UnsupportedEncodingException {
